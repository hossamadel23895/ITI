<div class="card">
    <div class="card-body bg-dark">
        ...
        @endif
        <form method="POST" class="comment_div" action="{{ route('comments.store') }}">
            @csrf
            @honeypot
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-dark @if($errors->has('guest_name')) is-invalid @endif" name="guest_name" />
                    @error('guest_name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control text-dark @if($errors->has('guest_email')) is-invalid @endif" name="guest_email" />
                    @error('guest_email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control text-dark @if($errors->has('message')) is-invalid @endif" name="message" rows="3"></textarea>
                <div class="invalid-feedback">
