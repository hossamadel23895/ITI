                        ...
                        <form method="POST" action="{{ route('comments.update', $comment->getKey()) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control text-dark" name="message" rows="3">{{ $comment->comment }}</textarea>
                        ...
                        <form method="POST" action="{{ route('comments.reply', $comment->getKey()) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control text-dark" name="message" rows="3"></textarea>
                                    <small class="form-text text-muted">@lang('comments::comments.markdown_cheatsheet', ['url' => 'https://help.github.com/articles/basic-writing-and-formatting-syntax'])</small>
                                </div>
                            </div>
                            <div class="modal-footer">
